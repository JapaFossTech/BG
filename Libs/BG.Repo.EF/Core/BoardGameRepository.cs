...
public class BoardGameRepository : IBoardGameRepository
{
    ...
    //    if (getDataRequest.FilterQuery is not null)
    //    {
    //        if (getDataRequest.FilterQuery.CheckHasData())
    //            query = query
    //                    .Where(boardGame =>
    //                        boardGame.Name != null
    //                            && boardGame.Name
    //                                .Contains(getDataRequest.FilterQuery));
    //    }

    //    var sortKeySelector = ConvertToKeySelectorExpression(
    //                                            getDataRequest.SortColumn);
    ...
    //    if (sortKeySelector is not null)
    //    {
    //        if (getDataRequest.SortOrder == "ASC")
    //            query = query.OrderBy(sortKeySelector);
    //        else
    //            query = query.OrderByDescending(sortKeySelector);
    //    }
    ...
    //    query = query
    //    //.OrderBy(keySelector)
    //            .Skip(getDataRequest.PageIndex * getDataRequest.PageSize)
    //            .Take(getDataRequest.PageSize)
    //            .Include(boardGame => boardGame.BoardGamesDomains)
    //            //.ThenInclude(boardGamesDomain => boardGamesDomain.Domain)
    //            .Include(boardGame => boardGame.BoardGamesMechanics)
    //    ;
